...
const META: Record<string, ProjectMeta> = {
  ...
  "deep-dive-memory-forensics-linux": {
    tags: ["forensics", "memory", "security"],
    languages: ["c"],
  },
  ...
  "deep-dive-mobile-forensics": {
    tags: ["forensics", "mobile", "security"],
    languages: [],
  },
  ...
  "deep-dive-cloud-forensics-containers": {
    tags: ["forensics", "containers", "security"],
    languages: [],
  },
  "deep-dive-cloud-forensics-kubernetes": {
    tags: ["forensics", "kubernetes", "security"],
    languages: [],
  },
  "deep-dive-filesystem-forensics": {
    tags: ["forensics", "filesystems", "security"],
    languages: [],
  },
  ...
  "deep-dive-database-forensics": {
    tags: ["forensics", "databases", "security"],
    languages: [],
  },
  ...
  "deep-dive-nix-darwin": {
    tags: ["nix", "macos", "darwin"],
    languages: ["nix"],
  },
  ...
  "deep-dive-pcb-design-custom-keeb": {
    tags: ["pcb", "hardware", "keebs"],
    languages: [],
  },
  ...
  "deep-dive-programming-c-writing-a-lexer": {
    tags: ["compilers"],
    languages: ["c"],
  },

  // -- Programming: Comparing --
  "deep-dive-programming-comparing-c-vs-cpp": {
    tags: [],
    languages: ["c", "cpp"],
  },
  "deep-dive-programming-comparing-swift-vs-cpp": {
    tags: [],
    languages: ["swift", "cpp"],
  },
  "deep-dive-programming-comparing-cpp-versions": {
    tags: [],
    languages: ["cpp"],
  },
  "deep-dive-programming-comparing-rust-vs-golang": {
    tags: [],
    languages: ["rust", "go"],
  },
  ...
  // -- Programming: Rust --
  "deep-dive-programming-rust-effective-rust": {
    tags: [],
    languages: ["rust"],
  },
  "deep-dive-programming-rust-reverse-engineering": {
  ...
  "deep-dive-programming-swift-effective-swift": {
    tags: [],
    languages: ["swift"],
  },
  "deep-dive-programming-swift-ios-app": {
    tags: ["ios"],
    languages: ["swift"],
  },
  "deep-dive-programming-swift-visionos-app": {
    tags: ["visionos"],
    languages: ["swift"],
  },
  ...
  "deep-dive-programming-swift-cross-platform-app": {
    tags: ["ios", "macos"],
    languages: ["swift"],
  },
  ...
  "deep-dive-reverse-engineering-ghidra": {
    tags: ["reverse-engineering", "security"],
    languages: [],
  },
  "deep-dive-reverse-engineering-ida-pro": {
    tags: ["reverse-engineering", "security"],
    languages: [],
  },
  "deep-dive-reverse-engineering-ida-free": {
    tags: ["reverse-engineering", "security"],
    languages: [],
  },
  "deep-dive-reverse-engineering-radare2": {
    tags: ["reverse-engineering", "security"],
    languages: [],
  },
  "deep-dive-reverse-engineering-good-resources": {
    tags: ["reverse-engineering", "security"],
    languages: [],
  },

  // -- Security / AI --
  "deep-dive-indirect-prompt-injection-email": {
    tags: ["security", "ai", "injection"],
    languages: [],
  },
  "deep-dive-llm-backdoor-taxonomy": {
    tags: ["security", "ai"],
    languages: [],
  },
  ...
  "deep-dive-semantic-testing-ai-skills": {
    tags: ["ai", "testing"],
    languages: [],
  },
  "deep-dive-llm-observability-agent-development": {
